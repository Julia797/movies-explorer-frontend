  ...
  return (
    <header className={nameHeader === "movies" || nameHeader === "saved-movies" || nameHeader === "profile" ?
      ...
      <ul className="header__navigation">
          <li>
            <Link to={'/movies'} className={nameHeader === "movies" || nameHeader === "profile" ? 
              "header__films header__films_bold" : nameHeader === "saved-movies" ? "header__films" : nameHeader === 'home' && loggedIn ? 
          ...
          <li>
            <Link to={'/saved-movies'} className={nameHeader === "movies" || nameHeader === "profile" ? 
             "header__films-save" : nameHeader === 'home' && loggedIn ? "header__films-save header__films-save_in" : nameHeader === "saved-movies" ?
        ...
        <Link to={'/profile'} className={nameHeader === "movies" || nameHeader === "saved-movies" || nameHeader === "profile" ? 
          "header__linkAcc" : nameHeader === 'home' && loggedIn ? "header__linkAcc header__linkAcc_in" : "header__none"}>Аккаунт <div className='header__account'>
            </div></Link>
      ...
      <button type='button' className={nameHeader === 'home' && loggedIn ? "header__burger header__burger_white" : nameHeader === "home" ?
       "header__burger header__burger_close" : "header__burger"} onClick={onClick}></button>
    </header>
  );
}
